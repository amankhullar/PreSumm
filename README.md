...
```
python preprocess.py -mode tokenize -raw_path ../raw_data/how2_stories/sum_train_300/ -save_path ../merged_stories_tokenized/
```

```
python preprocess.py -mode tokenize -raw_path ../raw_data/how2_stories/sum_cv_300/ -save_path ../merged_stories_tokenized_val/
```

```
python preprocess.py -mode tokenize -raw_path ../raw_data/how2_stories/sum_devtest_300/ -save_path ../merged_stories_tokenized_test/
```

```
mkdir merged_stories_tokenized
cp merged_stories_tokenized_*/* merged_stories_tokenized/
```
...
The directory how2 must be present in the json_data forlder
```
python preprocess.py -mode format_to_lines -raw_path ../merged_stories_tokenized -save_path ../json_data/how2 -n_cpus 1 -use_bert_basic_tokenizer false -map_path ../urls/
```
...
```
python train.py  -task abs -mode train -bert_data_path ../bert_data/how2 -dec_dropout 0.2 -model_path ../models/ -sep_optim true -lr_bert 0.002 -lr_dec 0.2 -save_checkpoint_steps 2000 -batch_size 4 -train_steps 200000 -report_every 50 -accum_count 5 -use_bert_emb true -use_interval true -warmup_steps_bert 20000 -warmup_steps_dec 10000 -max_pos 512 -visible_gpus 0  -log_file ../logs/abs_bert_cnnd
```
#### BertExtAbs
```
